<template>
    ...
    <div>
      ...
      <div class="contenedor-pasteles">
        ...
        <!-- <div class="fixed-bottom d-flex justify-content-end mr-3 mb-3">
          <b-button pill variant="info" class="ml-auto" to="/userinstitucion" @click="navigateTo">Crear Nuevo</b-button>
        </div> -->
  ...
  export default {
    ...
    methods: {
      navigateTo() {
        this.$router.push('/userinstitucion');
      },
      verReuniones(id) {
        this.$router.push({ name: 'reunionesuser', params: { id: id } });
      }
    },
